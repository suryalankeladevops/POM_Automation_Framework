...
//		}
	...
	//-------------------------- Surya added below code for Reports------------------------------
	
	@BeforeSuite
	public static void removeReportFolder() throws IOException {
		System.out.println("Remove report folder");
	String index = System.getProperty("user.dir") + "/Reports";
	...
	public void setUp() {
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/Reports/AutomationReport " +timeStamp+".html");
		...
		extent.setSystemInfo("User Name", "612497366");
	...
	public void getResult(ITestResult result) throws Exception {
		...
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			String screenShotPath = utilities.Utils.captureScreenshot(driver, result.getName());
			...
			System.out.println("Pass"+test.getStatus());
			...
			System.out.println("skip"+test.getStatus());
